...
- **HawaiiSTR → PermitPaddler 2026-05-21**: rebranded (hawaiistr.com was owned by an unrelated WordPress site). Canonical now `permitpaddler.ikenagroup.com`. Old hostnames 301 → new (path + querystring preserved). On bluewaveprojects.com: footer link updated, Portfolio.tsx card added (after Binnacle.ai), /press product list updated.
