    ...
    <div className="min-h-screen ocean-gradient flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-white/40 mt-1">Log in to continue your AI journey</p>
        </div>

        {/* Success message from registration */}
        {searchParams.get('registered') === 'true' && (
          <div className="mb-6 p-4 rounded-xl bg-green-500/10 border border-green-500/20 text-sm text-green-400 text-center">
        ...
        <div className="text-center mt-6 space-y-3">
          <p className="text-sm text-white/40">
            ...
            <Link href={`/signup${redirect !== '/school' ? `?redirect=${encodeURIComponent(redirect)}` : ''}`} className="text-ocean-400 hover:text-ocean-300 transition-colors">
              Sign up
            </Link>
          </p>
