...
export const metadata: Metadata = {
  ...
  description:
    "Solo full-stack AI engineer shipping production multi-tenant SaaS. ~12B Claude tokens, 580 commits, 600K LoC in 9 weeks. Available for remote founding / staff engineer roles at AI-native SaaS companies.",
  alternates: { canonical: "https://bluewaveprojects.com/work" },
  openGraph: {
    title: "John C. Thomas — Solo AI engineer · SaaS founder",
    description:
      "10+ products shipped in 9 weeks. Multi-tenant SaaS, LLM-in-loop pipelines, iOS + web + backend. Available for remote roles.",
    ...
    <main className="ocean-gradient min-h-screen text-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="mb-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold">
            10+ products. <span className="text-gradient">One operator.</span>
          </h2>
