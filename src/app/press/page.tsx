...
const products = [
  ...
  { name: "PermitPaddler", desc: "Hawaiʻi short-term rental compliance — all 4 counties. Permit renewals, GE/TAT/county-TAT filings, AI document classifier. Free TMK lookup + tax calendar download.", url: "https://permitpaddler.ikenagroup.com" },
