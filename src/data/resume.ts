...
export const resume = {
  ...
  velocity: [
    { value: "~15B", label: "Claude tokens processed", sub: "Through Claude Code on the home Apple server in one focused sprint" },
  ...
  products: [
    ...
    },
    {
      ...
      summary:
        "9-wave AI curriculum, 66 lessons, hundreds of exercises. Built as a separate product, currently de-emphasized on main funnel.",
      stack: "Next.js, MDX",
